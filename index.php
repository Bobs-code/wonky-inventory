...
?>
		<div class="jumbotron border mt-5">
			<h1 align="center" class="my-3"><?=lang("JOIN_SUC");?> <?php echo $settings->site_name;?></h1>
			...
			<h4 align="center" class="pb-4"><a href="https://userspice.com/getting-started/">https://userspice.com/getting-started/</a></h4>
		</div>
